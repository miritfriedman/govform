...
hand_fog<-subset(hand_fog, select=c(2,3,4,10))
hand_fog<-rename(hand_fog, "merged_FOG"="merged_FOG..1.yes..0.no.")
```

Bind the thin file with the handchecked files
```{r}
fog_thin<-rbind(fog_thin, hand_fog)
```
